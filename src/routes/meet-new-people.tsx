...
export const Route = createFileRoute("/meet-new-people")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://chatmingle.app/meet-new-people" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
    ],
    links: [{ rel: "canonical", href: "https://chatmingle.app/meet-new-people" }],
  }),
...
const BREADCRUMB_SCHEMA = JSON.stringify({
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 2, "name": "Meet New People", "item": "https://chatmingle.app/meet-new-people" },
  ],
});
