...
export const Route = createFileRoute("/chat-rooms")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.chatmingle.online/chat-rooms" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
    ],
    links: [{ rel: "canonical", href: "https://www.chatmingle.online/chat-rooms" }],
  }),
...
const BREADCRUMB_SCHEMA = JSON.stringify({
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 2, "name": "Free Chat Rooms", "item": "https://www.chatmingle.online/chat-rooms" },
  ],
});
